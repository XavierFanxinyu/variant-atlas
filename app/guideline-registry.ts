...
export const guidelineRecords: GuidelineRecord[] = [
  ...
  { id:"sv", title:"生殖系结构变异检测技术考虑", owner:"ACMG", version:"2023", published:"2023-02（在线2022-12-12）", reviewed:"2026-09-07", status:"现行", scope:"SV检测、事件重建、确认与报告", useWhen:"解释平衡/复杂重排、断点中断和多信号结构事件。", caution:"caller输出不是最终事件；需要整合split-read、discordant pair、深度和BAF等信号。", url:"https://pubmed.ncbi.nlm.nih.gov/36507974/" },
  { id:"mtdna", title:"mtDNA变异ACMG/AMP规范", owner:"ClinGen /专家组", version:"2020", published:"2020-12（在线2020-09）", reviewed:"2026-09-07", status:"现行", scope:"线粒体变异证据、异质性、组织和单倍群语境", useWhen:"解释WGS mtDNA发现及组织差异性异质性。", caution:"血液低水平或阴性不能代表其他组织；异质性比例不能单独预测严重度。", url:"https://pubmed.ncbi.nlm.nih.gov/32906214/" },
